...
const BitcoinInformationCard = ({ data }) => {
  return (
    <Card className="w-full">
      <CardHeader>
        <CardDescription>Placeholder description for Bitcoin</CardDescription>
      </CardHeader>
      <CardContent>
...
export default BitcoinInformationCard;