...
const PolkadotInformationCard = ({ data }) => {
  return (
    <Card className="w-full">
      <CardHeader>
        <CardDescription>Placeholder description for Polkadot</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <section>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>Native Token: Placeholder</li>
...
export default PolkadotInformationCard;
